...
[Authorize]
[Tags("Lists")]
[Route("api/lists/{listId:guid}/history")]
public class GetListHistoryController(IMediator mediator) : Controller
{
    [HttpGet]
    [ProducesResponseType(typeof(HistoryPage<ListHistoryType>), Status200OK)]
